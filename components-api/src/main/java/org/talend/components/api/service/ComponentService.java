...
public interface ComponentService extends PropertiesService<ComponentProperties> {
     ...
     * @exception ComponentException thrown if the connection name does not exists for the given component.
     */
     ...
     */
    Set<Connector> getAvailableConnectors(ComponentProperties componentProperties, Set<Connector> connectedConnetor,
            boolean isOuput);
